/* Generated from 'RDayOfTheWeek02.nrx' 22 Aug 2012 09:46:57 [v3.01] */
...
public class RDayOfTheWeek02{
 ...
 private static final netrexx.lang.Rexx $07=new netrexx.lang.Rexx(12);
 ...
 private static final netrexx.lang.Rexx $012=new netrexx.lang.Rexx(400);
 private static final netrexx.lang.Rexx $013=new netrexx.lang.Rexx(7);
 private static final java.lang.String $0="RDayOfTheWeek02.nrx";
 
 public static void main(java.lang.String $0s[]){
  netrexx.lang.Rexx days;
  int yearRanges[];
  netrexx.lang.Rexx messageTexts[];
  int dateRanges[][];
  netrexx.lang.Rexx s_=null;
  int month=0;
  int day=0;
  netrexx.lang.Rexx message=null;
  netrexx.lang.Rexx searchday=null;
  netrexx.lang.Rexx algorithmName[]=null;
  ...
  messageTexts=new netrexx.lang.Rexx[]{((($01.OpCcblank(null,new netrexx.lang.Rexx(yearRanges[0]))).OpCcblank(null,$02)).OpCcblank(null,new netrexx.lang.Rexx(yearRanges[1]))).OpCc(null,netrexx.lang.Rexx.toRexx(", Christmas day falls on a Sunday in the following years:")),((($01.OpCcblank(null,new netrexx.lang.Rexx(yearRanges[0]))).OpCcblank(null,$02)).OpCcblank(null,new netrexx.lang.Rexx(yearRanges[1]))).OpCc(null,netrexx.lang.Rexx.toRexx(", March 1st falls on a Sunday in the following years:"))};
  
  
  
  dateRanges=new int[][]{new int[]{new netrexx.lang.Rexx(12).toint(),25},new int[]{new netrexx.lang.Rexx(3).toint(),1}};
  
  {s_=new netrexx.lang.Rexx((byte)0);s_:for(;s_.OpLtEq(null,$03);s_=s_.OpAdd(null,new netrexx.lang.Rexx(1))){
   month=dateRanges[s_.toint()][0];
   day=dateRanges[s_.toint()][1];
   message=messageTexts[s_.toint()];
   ...
   {netrexx.lang.Rexx $1=new netrexx.lang.Rexx(algorithmName.length).OpSub(null,$04);alg=new netrexx.lang.Rexx((byte)0);alg:for(;alg.OpLtEq(null,$1);alg=alg.OpAdd(null,new netrexx.lang.Rexx(1))){
    sd=(searchday.getnode(new netrexx.lang.Rexx((byte)0)).leaf).OpAdd(null,$04);
    ...
    {netrexx.lang.Rexx $2=new netrexx.lang.Rexx(yearRanges[1]);year=new netrexx.lang.Rexx(yearRanges[0]).OpPlus(null);year:for(;year.OpLtEq(null,$2);year=year.OpAdd(null,new netrexx.lang.Rexx(1))){
     ...
     if (alg.OpEqS(null,new netrexx.lang.Rexx((byte)0)))
      dayIndex=getDaynumJavaLibrary(year.toint(),month,day);
     else if (alg.OpEqS(null,new netrexx.lang.Rexx((byte)1)))
      dayIndex=getDaynumZellersCongruenceV1(year.toint(),month,day);
     else if (alg.OpEqS(null,new netrexx.lang.Rexx((byte)2)))
      dayIndex=getDaynumZellersCongruenceV2(year.toint(),month,day);
     else if (alg.OpEqS(null,new netrexx.lang.Rexx((byte)3)))
      dayIndex=getDaynumSakamoto(year.toint(),month,day);
     else if (alg.OpEqS(null,new netrexx.lang.Rexx((byte)4)))
      dayIndex=getDaynumGauss(year.toint(),month,day);
     else if (alg.OpEqS(null,new netrexx.lang.Rexx((byte)5)))
      dayIndex=getDaynumKeith(year.toint(),month,day);
     else if (alg.OpEqS(null,new netrexx.lang.Rexx((byte)6)))
      dayIndex=getDaynumBabwani(year.toint(),month,day);
     else{
      ;
     }
     }
   ...
   {netrexx.lang.Rexx $3=searchday.getnode(new netrexx.lang.Rexx((byte)0)).leaf;r_=new netrexx.lang.Rexx((byte)1);r_:for(;r_.OpLtEq(null,$3);r_=r_.OpAdd(null,new netrexx.lang.Rexx(1))){
    ...
    netrexx.lang.RexxIO.Say(((searchday.getnode(netrexx.lang.Rexx.toRexx("agorithm")).leaf.getnode(r_).leaf.right(new netrexx.lang.Rexx((byte)20))).OpCc(null,$05)).OpCcblank(null,searchday.getnode(r_).leaf));
    }
   }/*r_*/
   }
  }/*s_*/
 ...
 public static int getDaynumZellersCongruenceV1(int Year,int Month,int Day,netrexx.lang.Rexx iso){
  ...
  if (new netrexx.lang.Rexx(Month).OpEq(null,$04)|new netrexx.lang.Rexx(Month).OpEq(null,$06)) 
   {
    Month=new netrexx.lang.Rexx(Month).OpAdd(null,$07).toint();
    Year=new netrexx.lang.Rexx(Year).OpSub(null,$04).toint();
   }
  ...
  // +--------------------------------------------------------------------------
  MonthFactor=$06.OpMult(null,new netrexx.lang.Rexx(Month)).OpAdd(null,$08.OpMult(null,(new netrexx.lang.Rexx(Month).OpAdd(null,$04))).OpDivI(null,$09));
  YearFactor=new netrexx.lang.Rexx(Year).OpAdd(null,new netrexx.lang.Rexx(Year).OpDivI(null,$010)).OpSub(null,new netrexx.lang.Rexx(Year).OpDivI(null,$011)).OpAdd(null,new netrexx.lang.Rexx(Year).OpDivI(null,$012));
  DayNum=((new netrexx.lang.Rexx(Day).OpAdd(null,MonthFactor).OpAdd(null,YearFactor))).OpRem(null,$013);
  
  if (netrexx.lang.Rexx.toRexx("YES").abbrev(iso.upper(),new netrexx.lang.Rexx((byte)1)).toboolean()) 
   d=DayNum.OpAdd(null,$04);/* Increment to allow indexing from 1 */
  else 
   d=DayNum;
 ...
 private RDayOfTheWeek02(){return;}
 }
