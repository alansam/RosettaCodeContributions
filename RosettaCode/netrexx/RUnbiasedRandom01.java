/* Generated from 'RUnbiasedRandom01.nrx' 6 Mar 2013 00:10:29 [v3.01] */
...
public class RUnbiasedRandom01{
 ...
 private static final java.lang.String $0="RUnbiasedRandom01.nrx";
 /* properties constant */
 protected static final java.util.Random rng=new java.util.Random(666);
 ...
 public static boolean biased(int n){
  return (rng.nextDouble())<(1.0F/((float)n));
  }
 //return Math.random(666) < 1.0 / n
 ...
 private RUnbiasedRandom01(){return;}
 }
