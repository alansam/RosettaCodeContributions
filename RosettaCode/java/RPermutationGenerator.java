/**
 *
 * @see http://rosettacode.org/wiki/Permutations#Java
...
public class RPermutationGenerator {
  ...
  public RPermutationGenerator(int n, int firstNum_) {
    if (n < 1) {
  ...
  // For testing of the RPermutationGenerator class
  public static void main(String[] args) {
    ...
    System.out.printf("Rows: %5d First Number: %5d%n", rows, num1);
    RPermutationGenerator pg = new RPermutationGenerator(rows, num1);
