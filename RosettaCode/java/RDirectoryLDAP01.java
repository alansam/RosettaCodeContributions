/*
 * -----------------------------------------------------------------------------
 * IVP.ApacheDS:RDirectoryLDAP01.java:Sep 28, 2012:1:19:34 PM
 *
 * (C) Copyright Alan Sampson <alansamps@gmail.com> 2012, All rights reserved.
 *
 * #(@) RDirectoryLDAP01.java $Header: $
 *
 * -----------------------------------------------------------------------------
 * echoEnv CLASSPATH
 * .
...
public class RDirectoryLDAP01 {
  ...
  public static final String ID = "@(#) RDirectoryLDAP01 $Header: $"; //$NON-NLS-1$

  public static final String MAINT = "@(#) INIT"; //$NON-NLS-1$

  public static final String CLASSNAME = RDirectoryLDAP01.class.getSimpleName();
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      try {
        ...
        String scope = "(objectclass=*)";
        SearchScope filter = SearchScope.ONELEVEL;
        String[] attributes = { "*", };
        ...
        try {
          ...
          log_.error("Error in cursor loop: Iteration " + ksearch, ex);
        }
