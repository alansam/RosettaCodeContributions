...
--  return numbers[size % 2 + size // 2]
  say numbers~toString("l", ", ")
  say size % 2 '|' size // 2 '|' size % 2 + size // 2 '?' numbers[size % 2 + size // 2]
  say size % 2 + 1 ':' numbers[size % 2 + 1] '|' (size - 1) % 2 + 1 ':' numbers[(size - 1) % 2 + 1] '=' (numbers[size % 2 + 1] + numbers[(size - 1) % 2 + 1]) / 2
*/
  return (numbers[size % 2 + 1] + numbers[(size - 1) % 2 + 1]) / 2
