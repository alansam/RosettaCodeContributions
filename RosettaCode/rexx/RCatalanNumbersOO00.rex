...
f = ml~length + 1
l = 10
hh = 'i'~right(f) 'catI(i)'~right(l) 'catR1(i)'~right(l) 'catR2(i)'~right(l)
say hh
loop i = 0 to ml
  say i~right(f) .catalan~catI(i)~format(l, 0) .catalan~catR1(i)~format(l, 0) .catalan~catR2(i)~format(l, 0)
  end i
say hh
