...
if bot == '' then do;
  top = 15;
  bot = 0;
  end /*No args? Use a range of 0--►15.*/
...
say;
say center(' Catalan numbers, method 1a ' , 79, '-')
!. = .;
do m1a = bot  to top
...
say;
say center(' Catalan numbers, method 1b ' , 79, '-')
!. = .;
do m1b = bot  to top
...
say;
say center(' Catalan numbers, method 2  ' , 79, '-')
!. = .;
c. = .;
c.0 = 1;
do m2 = bot  to top
...
say;
say center(' Catalan numbers, method 3  ' , 79, '-')
!. = .;
c. = .;
c.0 = 1;
do m3 = bot  to top
...
catalan1a:
procedure expose !.;
  parse arg n /*n+n  is faster than  2*n  */
...
procedure;
  parse arg x, y;
  return  pFact(x - y + 1, x) % pFact(2, y)
