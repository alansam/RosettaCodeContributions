...
do ask = 0;
  ...
  say prompt;
  say;
  parse pull yyyU . 1 yyy;
  say
  upper yyyU;
  if abbrev('QUIT', yyyU, 1) then exit
...
say 'numbers entered:' yyy;
say
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
do i = N by -1 to 1;
  p = word(yyy, i) / 1    /*process #s in reverse.*/
  g = f(p)
  numeric digits showdigs;
  g = g / 1        /*scale down the result.*/
