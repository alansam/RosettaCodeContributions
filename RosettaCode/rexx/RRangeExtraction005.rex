...
if userInput~words > 0 then do
  ...
  td.0 += 1; r_ = td.0; td.r_ = '-19, -18, -17, -16, -14, -13, -10, -8, -7, -6, -5, -3, -2, -1, 0, 3, 4, 5, 7, 8, 10, 11, 12'
  -- some end-point conditions
  td.0 += 1; r_ = td.0; td.r_ = 1
  td.0 += 1; r_ = td.0; td.r_ = 1 2
  td.0 += 1; r_ = td.0; td.r_ = 1 2 3
  td.0 += 1; r_ = td.0; td.r_ = 1 3 4 5
  td.0 += 1; r_ = td.0; td.r_ = 1 3 4 6
  td.0 += 1; r_ = td.0; td.r_ = '1 3 4 5 7'
  end
